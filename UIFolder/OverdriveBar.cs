/* Sadly, for now, this is in comment mode. RIP Overdrive Bar
...
namespace Unending.UIFolder
{
    internal class OverdriveBar : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            barFrame = new UIImage(GetTexture("Unending/UIFolder/barthing"));
            ...
            gradientA = new Color(255, 252, 189); // A dark purple
            gradientB = new Color(255, 128, 0); // A light purple
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            UnendingPlayer modPlayer = Main.LocalPlayer.GetModPlayer<UnendingPlayer>();
            float quotient = 1f;
            // Calculate quotient
            quotient = modPlayer.currentOverdrive / modPlayer.OverallMaximumOverdrive; // Creating a quotient that represents the difference of your currentResource vs your maximumResource, resulting in a float of 0-1f.
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            _text.SetText("Overdrive: " + modPlayer.currentOverdrive + " / " + modPlayer.OverallMaximumOverdrive);
