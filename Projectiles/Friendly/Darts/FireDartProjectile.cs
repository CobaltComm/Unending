...
{
    class FireDartProjectile : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Inferno Dart");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			aiType = ProjectileID.PoisonDartBlowgun;           //Acts like poison blowgun dart without the poison
		}
